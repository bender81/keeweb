...
const KeePassHttpFilter = function(windowInfo, appModel) {
...
KeePassHttpFilter.prototype.getEntries = function() {
    const filter = {
        text: this.text
    };
...
KeePassHttpFilter.prototype.hasWindowInfo = function() {
    return this.title || this.url;
};

KeePassHttpFilter.prototype.prepareFilter = function() {
...
KeePassHttpFilter.prototype.getEntryRank = function(entry) {
    let rank = 0;
...
KeePassHttpFilter.prototype.isSubdomain = function(domain1, domain2) {
...
KeePassHttpFilter.prototype.getStringRank = function(s1, s2) {
...
module.exports = KeePassHttpFilter;
